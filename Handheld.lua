...
if fs.exists("shop_utils")==false then shell.run("pastebin get G9S70Ugv shop_utils") end
if os.loadAPI("shop_utils") == false then error("Failed to load Shop Utils API") end
